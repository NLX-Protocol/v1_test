...
import BuyGlp from "pages/BuyGlp/BuyGlp"; // acting weird
...
import { CORE_TESTNET, DEFAULT_ALLOWED_SLIPPAGE_BPS, EXECUTION_FEE_CONFIG_V2, getExplorerUrl } from "config/chains";
...
function FullApp() {
  ...
  useEffect(() => {
    const wsVaultAbi =( chainId === CORE_TESTNET ) ? VaultV2.abi : VaultV2b.abi;
                ...
                renderContent={() => (
                  <div>
                    <Trans>
                      ...
                      executed. Only applicable to NLX.
                    </Trans>
                    <br />
                    <br />
                    {/* <ExternalLink href="https://docs.nlx.io/docs/trading/v2#execution-fee">Read more</ExternalLink> */}
                  </div>
                )}
              />
            </div>
