...
export const CHART_PERIODS = {
  "1m": 60 * 60 * 24, //1day
  "5m": 60 * 60 * 24 * 10, //10 days
  "15m": 60 * 60 * 24 * 15, //15 days
  "1h": 60 * 60 * 24 * 20, //20 days
  "4h": 60 * 60 * 24 * 25, //25 days
  "1d": 60 * 60 * 24 * 730, //2 years
  "funding_fee":60 * 60,
  "funding_fee_est":60 * 60 * 24,
};

export const PYTH_CHART_RESOLUTIONS = {
  "1m": 1,
  "5m": 5,
  "15m":15,
  "1h": 60,
...
export function getPageTitle(data) {
  const title = t`Decentralized Perpetual Exchange | NLX`;
  return `${data} | ${title}`;
}
