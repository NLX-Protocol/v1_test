  ...
  return (
    ...
    >
      ...
      <Trans>
        ...
        <ExternalLink href="https://github.com/NLX-Protocol">NLX front end</ExternalLink>, hosted and served on
      ...
      <Trans>
        ...
        <ExternalLink href="https://docs.nlx.trade">docs</ExternalLink>.
        <br />
        <br />
        By clicking Agree you accept the <ExternalLink href="https://nlx.trade">
          T&Cs
        </ExternalLink>{" "}
        and <ExternalLink href="https://nlx.trade">Referral T&Cs</ExternalLink>.
        <br />
        <br />
      </Trans>
