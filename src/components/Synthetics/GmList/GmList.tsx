...
export function GmList({
  ...
  return (
    <div className="GMList">
                  ...
                  <Tooltip
                    ...
                    renderContent={() => (
                      <p className="text-white">
                        <Trans>Available amount to deposit into the specific NX pool.</Trans>
                      </p>
                    )}
                  />
                </th>
                      ...
                      <p className="text-white">
                        <>
                          ...
                          {/* <p>
                            ...
                            <ExternalLink newTab href="https://dune.com/nlx-analytics">
                              NLX Dune Dashboard
                            </ExternalLink>
                            .
                          </p> */}
                  ...
                  return (
                    <tr key={token.address}>
                      ...
                      <td className="GmList-last-column">
                        {formatTokenAmount(totalSupply, token.decimals, "NX", {
                          useCommas: true,
                          displayDecimals: 2,
                        })}
      ...
      {isMobile && (
        <>
          {!hideTitle && <PageTitle title={t`NX Pools`} />}
...
function renderMintableAmount({ mintableInfo, market, token, longToken, shortToken }) {
  return (
    <Tooltip
      handle={
        <>
          {formatTokenAmount(mintableInfo?.mintableAmount, token.decimals, "NX", {
            useCommas: true,
            displayDecimals: 0,
          })}
          <br />(
      ...
      renderContent={() => (
        <>
          <p className="text-white">
            <>
              {longToken.symbol} can be used to buy NX tokens for this market up to the
