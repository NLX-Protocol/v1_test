...
export function MarketStats(p: Props) {
  ...
  const { longToken, longPoolAmount } = marketInfo || {};
      ...
      <div className="App-card-content">
          ...
          value={
            <Tooltip
              ...
              renderContent={() => {
                return (
                  <div>
                    <Trans>NX Token pricing includes positions' Pending PnL, Impact Pool Amount and Borrow Fees.</Trans>
                  </div>
                );
              }}
            />
        ...
        <CardRow
          ...
          value={
            marketTotalSupply && marketTotalSupplyUsd
              ? formatTokenAmountWithUsd(marketTotalSupply, marketTotalSupplyUsd, "NX", marketToken?.decimals, {
                  displayDecimals: 0,
                })
              : "..."
          }
                  ...
                  return (
                    <div>
                      {marketInfo?.isSameCollaterals ? (
                        <Trans>
                          {marketInfo?.longToken.symbol} can be used to buy NX for this market up to the specified
                          buying caps.
                        </Trans>
                      ) : (
                        <Trans>
                          {marketInfo?.longToken.symbol} and {marketInfo?.shortToken.symbol} can be used to buy NX for
        ...
        <CardRow
          ...
          value={
            <Tooltip
              handle={formatTokenAmountWithUsd(
                sellableInfo?.maxLongSellableAmount,
                sellableInfo?.maxLongSellableUsd,
                "NX",
                marketToken?.decimals,
                {
              ...
              renderContent={() => (
                <div>
                  <>
                    NX can be sold for {longToken?.symbol} for this market up to the specified
        ...
        <CardRow label={t`Long/Short Collateral`} value={longToken?.symbol || "..."} />
        <CardRow
          label={t`Pool Amount`}
