...
import { formatAmount, formatBonk, formatUsd, numberWithCommas } from "lib/numbers";
          ...
          <div className="ExchangeChart-top-inner">
            ...
            <div className="Chart-min-max-price">
              <div className="ExchangeChart-main-price">
                {chartToken?.name === "Bonk" ? formatBonk(chartToken?.prices?.maxPrice, {
              ...
              {chartToken?.name === "Bonk" ? formatBonk(chartToken?.prices?.minPrice, {
                  displayDecimals: chartToken?.priceDecimals,
