...
import { formatBonk, formatDeltaUsd, formatTokenAmount, formatUsd } from "lib/numbers";
...
export function PositionItem(p: Props) {
  ...
  function renderLiquidationPrice() {
    ...
    if (liqPriceWarning || estimatedLiquidationHours) {
      return (
        <Tooltip
          handle={p.position.indexToken.symbol==="BONK"? formatBonkLiquidationPrice(p.position.liquidationPrice, { displayDecimals: indexPriceDecimals }) || "..." :formatLiquidationPrice(p.position.liquidationPrice, { displayDecimals: indexPriceDecimals }) || "..."}
          position={p.isLarge ? "left-bottom" : "right-bottom"}
    ...
    return p.position.indexToken.symbol==="BONK"? formatBonkLiquidationPrice(p.position.liquidationPrice, { displayDecimals: indexPriceDecimals }) || "..." : formatLiquidationPrice(p.position.liquidationPrice, { displayDecimals: indexPriceDecimals }) || "...";
  }
    ...
    return (
      ...
      >
        ...
        <td>
          ...
          {p.position.isOpening
            ? t`Opening...`
            : p.position.indexToken.symbol==="BONK"? formatBonk(p.position.entryPrice, {
        ...
        <td>
          {/* markPrice */}
          {p.position.indexToken.symbol==="BONK"? formatBonk(p.position.markPrice, {
            displayDecimals: indexPriceDecimals,
        ...
        <div>
          ...
          <div className="App-card-content">
            <div className="App-card-row">
              ...
              <div>
                {p.position.indexToken.symbol==="BONK"?
                formatBonk(p.position.entryPrice, {
                  displayDecimals: indexPriceDecimals,
                })
                : formatUsd(p.position.entryPrice, {
                  displayDecimals: indexPriceDecimals,
            ...
            <div className="App-card-row">
              ...
              <div>
                {p.position.indexToken.symbol==="BONK"?
                formatBonk(p.position.markPrice, {
                  displayDecimals: indexPriceDecimals,
                }): formatUsd(p.position.markPrice, {
                  displayDecimals: indexPriceDecimals,
                })
