import {  CORE_TESTNET } from "config/chains";
...
const chartOverrides = {
  ...
  "paneProperties.backgroundGradientStartColor": "#191919",
  "paneProperties.backgroundGradientEndColor": "#191919",
...
export const defaultChartProps = {
  ...
  loading_screen: { backgroundColor: "#191919", foregroundColor: "#191919" },
  favorites: {},
  custom_formatters: {
    timeFormatter: {
...
export const availableNetworksForChart = [CORE_TESTNET];
