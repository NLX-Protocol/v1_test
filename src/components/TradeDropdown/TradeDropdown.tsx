      ...
      <Menu>
        ...
        <Menu.Items as="div" className="TradeDropdown-options  menu-items">
          <Menu.Item>
            ...
            >
              <img src={getIcon("common", "gmxOutline")} alt="NLX V1" className="TradeDropdown-option-icon" />
              <div className="TradeDropdown-option-label">NLX V1</div>
            </HeaderLink>
          </Menu.Item>
          ...
          <Menu.Item>
            <HeaderLink
              ...
              showRedirectModal={showRedirectModal}
            >
              <img src={getIcon("common", "gmxOutline")} alt="NLX V2" className="TradeDropdown-option-icon" />
              <div className="TradeDropdown-option-label">NLX</div>
            </HeaderLink>
          </Menu.Item>
        </Menu.Items>
      </Menu>
