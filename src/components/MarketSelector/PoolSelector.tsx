...
export function PoolSelector({
  ...
  function displayPoolLabel(marketInfo: MarketInfo | undefined) {
    ...
    const name = showAllPools ? `NX: ${getMarketIndexName(marketInfo)}` : getMarketPoolName(marketInfo);
              ...
              >
                ...
                <div className="Token-info">
                  <div className="collaterals-logo">
                    {showAllPools ? (
                      ...
                      <>
                        <TokenIcon
                          symbol={indexToken?.marketSeperator!}
                          displaySize={40}
                          importSize={40}
                        ...
                        {shortToken && (
                          <TokenIcon
                            symbol={shortToken?.displaySymbol!}
                            displaySize={40}
                            importSize={40}
                ...
                <div className="Token-balance">
                  {showBalances && balance && (
                    <div className="Token-text">
                      {balance.gt(0) &&
                        formatTokenAmount(balance, marketToken?.decimals, "NX", {
                          useCommas: true,
                        })}
                      {balance.eq(0) && "-"}
                    </div>
