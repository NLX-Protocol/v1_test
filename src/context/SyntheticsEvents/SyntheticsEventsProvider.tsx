  ...
  eventLogHandlers.current = {
    ...
    DepositCreated: (eventData: EventLogData, txnParams: EventTxnParams) => {
      const depositData: DepositCreatedEventData = {
        ...
        initialLongTokenAmount: (eventData.uintItems.items.initialLongTokenAmount).div(BigNumber.from(2)),
        initialShortTokenAmount: (eventData.uintItems.items.initialLongTokenAmount).div(BigNumber.from(2)),
