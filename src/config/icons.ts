import { ARBITRUM, ARBITRUM_GOERLI, AVALANCHE, AVALANCHE_FUJI, CORE_TESTNET } from "config/chains";
import coreTestnet from "img/coreTestnet.png";
import nx from "img/logo_nx.png";
