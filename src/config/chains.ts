...
export const CORE_TESTNET = 1115;
...
export const DEFAULT_CHAIN_ID = CORE_TESTNET;
export const CHAIN_ID = DEFAULT_CHAIN_ID;

export const SUPPORTED_CHAIN_IDS = [CORE_TESTNET, ARBITRUM, AVALANCHE];
...
export const NETWORK_METADATA: { [chainId: number]: NetworkMetadata } = {
  [CORE_TESTNET]: {
    chainId: "0x" + CORE_TESTNET.toString(16),
    ...
    rpcUrls: RPC_PROVIDERS[CORE_TESTNET],
    blockExplorerUrls: [getExplorerUrl(CORE_TESTNET)],
  },
  // [LOCALHOST]: {
  //   chainId: "0x" + LOCALHOST.toString(16),
  //   chainName: "Core localhost",
  //   nativeCurrency: {
  //     name: "tCORE",
  //     symbol: "tCORE",
  //     decimals: 18,
  ...
  //   blockExplorerUrls: [getExplorerUrl(LOCALHOST)],
  // },
  [BCS_MAINNET]: {
