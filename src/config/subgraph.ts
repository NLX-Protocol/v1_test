import { ARBITRUM, ARBITRUM_GOERLI, AVALANCHE, AVALANCHE_FUJI, CORE_TESTNET, ETH_MAINNET } from "./chains";
...
const SUBGRAPH_URLS = {
  ...
  [CORE_TESTNET]: {
    stats: "https://thegraph.test.btcs.network/subgraphs/name/nlx-testnet-stats",
    referrals: "https://thegraph.test.btcs.network/subgraphs/name/nlx-testnet-referrals",
    nissohVault: "https://api.thegraph.com/subgraphs/name/nissoh/gmx-vault",
    syntheticsStats:
      "https://thegraph.test.btcs.network/subgraphs/name/nlx-testnet-stats",
  },
