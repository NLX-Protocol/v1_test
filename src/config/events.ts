...
export const homeEventsData: EventData[] = [
  {
    id: "v2-live",
    title: "NLX V2 beta is live",
    isActive: true,
    validTill: "9 Sep 2023, 12:00",
    bodyText: "NLX beta is now available for public use.",
    buttons: [
      {
        text: "Read More",
...
export const appEventsData: EventData[] = [
  {
    ...
    isActive: true,
    validTill: "9 Sep 2023, 12:00",
    bodyText: "NLX V2 beta is now available for public use.",
    buttons: [
      {
        text: "Read More",
        link: "https://nlx.trade",
